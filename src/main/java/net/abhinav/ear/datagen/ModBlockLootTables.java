...
public class ModBlockLootTables extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.DEEPSLATE_RUBY_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.DEEPSLATE_RUBY_ORE.get(), ModItems.RAW_RUBY.get(), 2, 5));
        this.add(ModBlocks.END_STONE_RUBY_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.END_STONE_RUBY_ORE.get(), ModItems.RAW_RUBY.get(), 4, 8));
        this.add(ModBlocks.NETHER_RUBY_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.NETHER_RUBY_ORE.get(), ModItems.RAW_RUBY.get(), 1, 6));
    }
